...
interface WalletsClientLayoutProps {
  children: ReactNode;
}

/**
 * Wallets client layout component
 * 
 * This is the client-side layout component that handles all the UI state
 * and interactions. The authentication validation is handled by the parent
 * Server Component layout.
 */
export function WalletsClientLayout({ children }: WalletsClientLayoutProps) {
  ...
  const isSubscriptionPage =
    pathname?.includes("/subscriptions/new") ||
