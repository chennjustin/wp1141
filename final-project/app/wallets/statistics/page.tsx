...
/**
 * Statistics page redirect handler
 *
 * This page redirects to the current wallet's statistics page.
...
export default function StatisticsPage() {
  ...
  useEffect(() => {
    ...
    if (defaultWalletId && wallets.some((w) => w.id === defaultWalletId)) {
      router.push(`/wallets/${defaultWalletId}/statistics`);
      return;
    }
    ...
    if (firstWallet) {
      router.push(`/wallets/${firstWallet.id}/statistics`);
    }
